...
def da_particle_filtering(src_train,
                         trgt_train
                         trgt_test,
    ...
    src_hmm.learn(emi_seqs=[src_train.data[src_train_start:src_train_end, feature_col]], hidd_seqs=[src_train.occupancy[src_train_start:src_train_end]])
    ...
    trgt_hmm.learn(emi_seqs=[trgt_train.data[trgt_train_start:trgt_train_end, feature_col]], hidd_seqs=[trgt_train.occupancy[trgt_train_start:trgt_train_end]])

    predict_occupancy = trgt_hmm.pf_predict(emi_seqs=[trgt_test.data[trgt_test_start:trgt_test_end, feature_col]], p=None, q=src_hmm.A, number_of_particles=number_of_particles)[0]
