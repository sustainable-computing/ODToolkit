...
def load_sample(sample_name):
    """
    Load one or more odtoolkit.data.dataset.Dataset object from the sample folder

    :type sample_name: str or list(str)
    :type sample_name: str or list(str)
    :param sample_name: name(s) of the binary file in binary_dataset

    :rtype: odtoolkit.data.dataset.Dataset or dict(str, odtoolkit.data.dataset.Dataset)
