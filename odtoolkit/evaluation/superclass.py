...
class BinaryEvaluation:
    ...
    :rtype: odtoolkit.evaluation.superclass.BinaryEvaluation
    """
    def __init__(self,
                 predict,
                 truth):
...
class OccupancyEvaluation:
    ...
    :rtype: odtoolkit.evaluation.superclass.OccupancyEvaluation
    """
    def __init__(self,
                 predict,
                 truth):
...
# odtoolkit.evaluation.superclass.Result is for transform the evaluation result to a 3D array and select required data.
...
class Result:
    ...
    :return: odtoolkit.evaluation.superclass.Result
    """
    def __init__(self):
        self.result = None
        self.metrics = list()
