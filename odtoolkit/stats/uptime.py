# Parameters:
#     dataset: odtoolkit.data.dataset.Dataset()
#     threshold: maximum different second between two consecutive value
#     gaps: All gaps detected by odtoolkit.stats.gap_detect
# Return:
...
def uptime(dataset, threshold, gaps=None):
    ...
    :parameter gaps: a dictionary result from the odtoolkit.stats.gap_detect
