...
def change_to_one_hot(dataset):
    """
    Change the occupancy data in odtoolkit.data.dataset.Dataset to one hot encoding
    ...
    if not isinstance(dataset, Dataset):
        raise TypeError("Dataset has to be class odtoolkit.data.dataset.Dataset")
...
def change_to_label(dataset):
    """
    Change the occupancy data in odtoolkit.data.dataset.Dataset to label encoding
...
def change_to_binary(dataset):
    """
    Change the occupancy data in odtoolkit.data.dataset.Dataset to binary
